...
def marcar_y_mostrar(frame, x_cor, y_cor, w_, h_):
    ...
    cv2.imwrite('/home/srm/Documents/dobot_/dobot_API/detection.jpg',frame)
...
(x_, y_, z_, rot, j1, j2, j3, j4) = device.pose()

device.move_to(300, 0, -60, 90, wait=True)  # we wait until this movement is done before continuing
